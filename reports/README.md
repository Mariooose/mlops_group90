...
* [o] Add a model to `model.py` and a training procedure to `train.py` and get that running (M6)
* [o] Remember to fill out the `requirements.txt` and `requirements_dev.txt` file with whatever dependencies that you
    are using (M2+M6)
* [o] Remember to comply with good coding practices (`pep8`) while doing the project (M7)
